...
const STATUS_STYLES: Record<string, { bg: string; text: string; solid: string }> = {
  novo:        { bg: 'rgba(28,64,97,0.12)',   text: '#1C4061', solid: '#1C4061' },
  contato:     { bg: 'rgba(46,124,196,0.12)', text: '#2E7CC4', solid: '#2E7CC4' },
  diagnostico: { bg: 'rgba(14,154,167,0.12)', text: '#0E9AA7', solid: '#0E9AA7' },
  proposta:    { bg: 'rgba(108,92,231,0.12)', text: '#6C5CE7', solid: '#6C5CE7' },
